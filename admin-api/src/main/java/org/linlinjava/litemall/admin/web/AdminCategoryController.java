...
public class AdminCategoryController {
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "类目管理"}, button = "查询")
    @GetMapping("/list")
    public Object list() {
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "类目管理"}, button = "添加")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "类目管理"}, button = "详情")
    @GetMapping("/read")
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "类目管理"}, button = "编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "类目管理"}, button = "删除")
    @PostMapping("/delete")
