...
public class AdminConfigController {
    ...
    @RequiresPermissions("admin:config:contract:list")
    @RequiresPermissionsDesc(menu = {"配置管理", "合同配置"}, button = "详情")
    @GetMapping("/order")
    ...
    @RequiresPermissions("admin:config:contract:updateConfigs")
    @RequiresPermissionsDesc(menu = {"配置管理", "合同配置"}, button = "编辑")
    @PostMapping("/order")
