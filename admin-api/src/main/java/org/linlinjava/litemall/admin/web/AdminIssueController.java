...
import org.linlinjava.litemall.db.service.IssueService;
...
public class AdminIssueController {
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "通用问题"}, button = "查询")
    @GetMapping("/list")
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "通用问题"}, button = "添加")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "通用问题"}, button = "编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu = {"平台管理", "通用问题"}, button = "删除")
    @PostMapping("/delete")
