...
public class AdminStorageController {
    ...
    public Object list(String key, String name,
        ...
        List<Storage> storageList = DBStorageService.querySelective(key, name, page, limit, sort, order);
    ...
    public Object create(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        Storage litemallStorage = storageService.store(file.getInputStream(), file.getSize(),
    ...
    public Object read(@NotNull Integer id) {
        Storage storageInfo = DBStorageService.findById(id);
        if (storageInfo == null) {
    ...
    public Object update(@RequestBody Storage storage) {
        if (DBStorageService.update(storage) == 0) {
