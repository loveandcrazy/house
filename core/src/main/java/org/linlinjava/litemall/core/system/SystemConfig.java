...
public class SystemConfig {
    ...
    public final static String LITEMALL_WX_INDEX_CATLOG_HOUSE = "litemall_wx_catlog_house";
    public final static String LITEMALL_WX_SHARE = "litemall_wx_share";

    // 订单相关配置

    public final static String LITEMALL_CONTRACT_UNCONFIRM = "litemall_order_unconfirm";
    public final static String LITEMALL_CONTRACT_COMMENT = "litemall_order_comment";
    // 商场相关配置
    ...
    public static Integer getCatlogMoreLimit() {
        return getConfigInt(LITEMALL_WX_INDEX_CATLOG_HOUSE);
    }
    ...
    public static Integer getContractUnconfirm() {
        return getConfigInt(LITEMALL_CONTRACT_UNCONFIRM);
    }

    public static Integer getContractComment() {
        return getConfigInt(LITEMALL_CONTRACT_COMMENT);
    }
