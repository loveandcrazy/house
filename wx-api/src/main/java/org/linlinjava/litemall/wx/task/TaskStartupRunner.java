...
import org.linlinjava.litemall.db.service.ContractService;
...
//        List<Contract> orderList = orderService.queryUnpaid(SystemConfig.getOrderUnpaid());
//        for(Contract order : orderList){
