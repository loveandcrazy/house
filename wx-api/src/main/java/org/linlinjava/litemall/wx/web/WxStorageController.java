...
public class WxStorageController {
    ...
    @Autowired
    private org.linlinjava.litemall.db.service.DBStorageService DBStorageService;
    @Autowired
...
//        storageService.setActive("local");
    ...
    public ResponseEntity<Resource> fetch(@PathVariable String key) {
        Storage Storage = DBStorageService.findByKey(key);
        if (key == null) {
